...
// Navbar elevation change on scroll (theme-aware via CSS variables)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const slideElements = document.querySelectorAll('.hero-content, .about-text, .contact-info');
    slideElements.forEach(element => {
        element.classList.add('slide-in-left');
        observer.observe(element);
    });

    const slideRightElements = document.querySelectorAll('.hero-image, .about-stats, .contact-form');
